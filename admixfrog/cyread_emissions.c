 ...
 */
  ...
  /* "admixfrog/cyread_emissions.pyx":11
 ...
 *     update emissions by maximizing contamination parameter
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9admixfrog_16cyread_emissions_1update_contamination, NULL, __pyx_n_s_admixfrog_cyread_emissions); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
