    ...
    for i in range(len(seq)):
        ...
        if i == 0:
            ...
            if (c1 == r1 and c2 == r2) or (c1 == r2 and c2 == r1):
                ...
                l1, l2 = l1 + 1, l2 + 1
            # one strand ends
            elif (c1 == r1 and c2 != r2) or (c1 == r2 and c2 != r1) or \
                (c2 == r1 and c1 != r2) or (c2 == r2 and c1 != r1):
...
def pred_sims_single(trans, emissions, beta, alpha0, n, n_homo, n_sims=100, decode=True):
    sims = []
