...
static PyObject *__pyx_pf_9admixfrog_13distributions_gt_homo_gtmode(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_o, __Pyx_memviewslice __pyx_v_n, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res); /* proto */
static PyObject *__pyx_pf_9admixfrog_13distributions_2gt_homo_dist(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res); /* proto */
...
/* "admixfrog/distributions.pyx":11
...
/* Python wrapper */
static PyObject *__pyx_pw_9admixfrog_13distributions_1gt_homo_gtmode(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_9admixfrog_13distributions_1gt_homo_gtmode = {"gt_homo_gtmode", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9admixfrog_13distributions_1gt_homo_gtmode, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9admixfrog_13distributions_1gt_homo_gtmode(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("admixfrog.distributions.gt_homo_gtmode", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9admixfrog_13distributions_gt_homo_gtmode(__pyx_self, __pyx_v_o, __pyx_v_n, __pyx_v_a, __pyx_v_b, __pyx_v_F, __pyx_v_tau, __pyx_v_n_snps, __pyx_v_res);
...
static PyObject *__pyx_pf_9admixfrog_13distributions_gt_homo_gtmode(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_o, __Pyx_memviewslice __pyx_v_n, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res) {
  ...
  /* "admixfrog/distributions.pyx":18
 *                    double F, double tau, long n_snps, double[:] res):
 *     cdef int i
...
/* Python wrapper */
static PyObject *__pyx_pw_9admixfrog_13distributions_3gt_homo_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_9admixfrog_13distributions_3gt_homo_dist = {"gt_homo_dist", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9admixfrog_13distributions_3gt_homo_dist, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9admixfrog_13distributions_3gt_homo_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_b = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_F;
  double __pyx_v_tau;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9admixfrog_13distributions_2gt_homo_dist(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_F, __pyx_v_tau, __pyx_v_n_snps, __pyx_v_res);
...
static PyObject *__pyx_pf_9admixfrog_13distributions_2gt_homo_dist(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
...
/* "admixfrog/distributions.pyx":24
 * def gt_homo_dist(double[:] a, double[:] b, double F, double tau, long n_snps, double[:, :] res):
 *     _gt_homo_dist_tau(a, b, F, tau, n_snps, res)
 * cdef void _gt_homo_dist(double[:] a, double[:] b, double F, long n_snps, double[:, :] res):             # <<<<<<<<<<<<<<
 *     cdef long i, g
 ...
 */
    ...
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_24 * __pyx_v_res.strides[0]) ) + __pyx_t_25 * __pyx_v_res.strides[1]) )) = ((((((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_15 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_16 * __pyx_v_a.strides[0]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_17 * __pyx_v_a.strides[0]) )))) + (((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_18 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_19 * __pyx_v_b.strides[0]) )))) * __pyx_v_F)) / ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_20 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_21 * __pyx_v_b.strides[0]) ))))) / (((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_22 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_23 * __pyx_v_b.strides[0]) )))) + 1.0));
    ...
    /* "admixfrog/distributions.pyx":29
 *         res[i, 0] =  (b[i]*b[i] + b[i] + a[i]*b[i]*F) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 *         res[i, 2] =  (a[i]*a[i] + a[i] + a[i]*b[i]*F) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 *         res[i, 1] =  (2.*a[i]*b[i]*(1-F)) / (a[i] + b[i]) / (a[i] + b[i] + 1)             # <<<<<<<<<<<<<<
 * 
...
/* "admixfrog/distributions.pyx":31
 *         res[i, 1] =  (2.*a[i]*b[i]*(1-F)) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 * 
 * cdef void _gt_homo_dist_tau(double[:] a, double[:] b, double F, double tau, long n_snps, double[:, :] res):             # <<<<<<<<<<<<<<
 *     cdef long i, g
...
static void __pyx_f_9admixfrog_13distributions__gt_homo_dist_tau(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res) {
  ...
  /* "admixfrog/distributions.pyx":33
 * cdef void _gt_homo_dist_tau(double[:] a, double[:] b, double F, double tau, long n_snps, double[:, :] res):
 *     cdef long i, g
 *     for i in range(n_snps):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "admixfrog/distributions.pyx":34
 *     cdef long i, g
 *     for i in range(n_snps):
 *         res[i, 0] =  (b[i]*b[i]*tau + b[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)             # <<<<<<<<<<<<<<
 *         res[i, 2] =  (a[i]*a[i]*tau + a[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)
 ...
 */
    ...
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_13 * __pyx_v_res.strides[0]) ) + __pyx_t_14 * __pyx_v_res.strides[1]) )) = (((((((*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_4 * __pyx_v_b.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_5 * __pyx_v_b.strides[0]) )))) * __pyx_v_tau) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_6 * __pyx_v_b.strides[0]) )))) + ((((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_7 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_8 * __pyx_v_b.strides[0]) )))) * __pyx_v_F) * __pyx_v_tau)) / ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_9 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_10 * __pyx_v_b.strides[0]) ))))) / (((__pyx_v_tau * (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_11 * __pyx_v_a.strides[0]) )))) + (__pyx_v_tau * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_12 * __pyx_v_b.strides[0]) ))))) + 1.0));
    ...
    /* "admixfrog/distributions.pyx":35
 *     for i in range(n_snps):
 *         res[i, 0] =  (b[i]*b[i]*tau + b[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)
 *         res[i, 2] =  (a[i]*a[i]*tau + a[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)             # <<<<<<<<<<<<<<
 *         res[i, 1] =  1 - res[i, 0] - res[i, 2] #(2.*a[i]*b[i]*(1-F) * (1-tau)) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 ...
 */
    ...
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_24 * __pyx_v_res.strides[0]) ) + __pyx_t_25 * __pyx_v_res.strides[1]) )) = (((((((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_15 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_16 * __pyx_v_a.strides[0]) )))) * __pyx_v_tau) + (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_17 * __pyx_v_a.strides[0]) )))) + ((((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_18 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_19 * __pyx_v_b.strides[0]) )))) * __pyx_v_F) * __pyx_v_tau)) / ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_20 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_21 * __pyx_v_b.strides[0]) ))))) / (((__pyx_v_tau * (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_22 * __pyx_v_a.strides[0]) )))) + (__pyx_v_tau * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_23 * __pyx_v_b.strides[0]) ))))) + 1.0));
    ...
    /* "admixfrog/distributions.pyx":36
 *         res[i, 0] =  (b[i]*b[i]*tau + b[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)
 *         res[i, 2] =  (a[i]*a[i]*tau + a[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)
 *         res[i, 1] =  1 - res[i, 0] - res[i, 2] #(2.*a[i]*b[i]*(1-F) * (1-tau)) / (a[i] + b[i]) / (a[i] + b[i] + 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "admixfrog/distributions.pyx":41
 *     if n == 0:
 *         return 1
 *     if n == 1:             # <<<<<<<<<<<<<<
 *         return (a * o + b * (1-o)) / (a + b)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "admixfrog/distributions.pyx":42
 *         return 1
 *     if n == 1:
 *         return (a * o + b * (1-o)) / (a + b)             # <<<<<<<<<<<<<<
 *     if n == 2:
 ...
 */
  ...
  /* "admixfrog/distributions.pyx":43
 *     if n == 1:
 *         return (a * o + b * (1-o)) / (a + b)
 *     if n == 2:             # <<<<<<<<<<<<<<
 *         if o == 0:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "admixfrog/distributions.pyx":44
 *         return (a * o + b * (1-o)) / (a + b)
 *     if n == 2:
 *         if o == 0:             # <<<<<<<<<<<<<<
 *             return  (b*b*tau + b + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 ...
 */
    switch (__pyx_v_o) {
      ...
      /* "admixfrog/distributions.pyx":45
 *     if n == 2:
 *         if o == 0:
 *             return  (b*b*tau + b + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)             # <<<<<<<<<<<<<<
 *         elif o == 2:
 ...
 */
      ...
      /* "admixfrog/distributions.pyx":47
 *             return  (b*b*tau + b + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 *         elif o == 2:
 *             return (a*a*tau + a + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)             # <<<<<<<<<<<<<<
 *         elif o == 1:
 ...
 */
      ...
      /* "admixfrog/distributions.pyx":46
 *         if o == 0:
 *             return  (b*b*tau + b + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 *         elif o == 2:             # <<<<<<<<<<<<<<
 *             return (a*a*tau + a + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 ...
 */
      ...
      /* "admixfrog/distributions.pyx":49
 *             return (a*a*tau + a + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 *         elif o == 1:
 *             return (a*b*(1-F) * tau) / (a + b) / (tau *a + tau *b + 1)             # <<<<<<<<<<<<<<
 *     return -1
 */
      ...
      /* "admixfrog/distributions.pyx":48
 *         elif o == 2:
 *             return (a*a*tau + a + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 *         elif o == 1:             # <<<<<<<<<<<<<<
 *             return (a*b*(1-F) * tau) / (a + b) / (tau *a + tau *b + 1)
 ...
 */
  ...
  /* "admixfrog/distributions.pyx":50
 *         elif o == 1:
 *             return (a*b*(1-F) * tau) / (a + b) / (tau *a + tau *b + 1)
 *     return -1             # <<<<<<<<<<<<<<
 */
 ...
 *                    double F, double tau, long n_snps, double[:] res):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9admixfrog_13distributions_1gt_homo_gtmode, NULL, __pyx_n_s_admixfrog_distributions); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * cdef void _gt_homo_dist(double[:] a, double[:] b, double F, long n_snps, double[:, :] res):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9admixfrog_13distributions_3gt_homo_dist, NULL, __pyx_n_s_admixfrog_distributions); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init admixfrog.distributions", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
