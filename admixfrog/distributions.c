...
static PyMethodDef __pyx_mdef_9admixfrog_13distributions_1gt_homo_dist = {"gt_homo_dist", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9admixfrog_13distributions_1gt_homo_dist, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9admixfrog_13distributions_1gt_homo_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("gt_homo_dist (wrapper)", 0);
  {
    ...
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 15, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_b.memview)) __PYX_ERR(0, 15, __pyx_L3_error)
    ...
    __pyx_v_res = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_res.memview)) __PYX_ERR(0, 15, __pyx_L3_error)
  }
 ...
 * cdef void _gt_homo_dist(double[:] a, double[:] b, double F, long n_snps, double[:, :] res):
 */
  __pyx_tuple__19 = PyTuple_Pack(5, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_F, __pyx_n_s_n_snps, __pyx_n_s_res); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(5, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_admixfrog_distributions_pyx, __pyx_n_s_gt_homo_dist, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 15, __pyx_L1_error)
 ...
 * cdef void _gt_homo_dist(double[:] a, double[:] b, double F, long n_snps, double[:, :] res):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9admixfrog_13distributions_1gt_homo_dist, NULL, __pyx_n_s_admixfrog_distributions); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_gt_homo_dist, __pyx_t_1) < 0) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
