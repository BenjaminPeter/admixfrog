...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "admixfrog.utils.distributions",
        "sources": [
            "admixfrog/utils/distributions.pyx"
        ]
    },
    "module_name": "admixfrog.utils.distributions"
}
END: Cython Metadata */
...
#define __PYX_HAVE__admixfrog__utils__distributions
#define __PYX_HAVE_API__admixfrog__utils__distributions
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
static double (*__pyx_f_5scipy_7special_14cython_special_binom)(double, double, int __pyx_skip_dispatch); /*proto*/
...
/* Module declarations from 'admixfrog.utils.distributions' */
...
static void __pyx_f_9admixfrog_5utils_13distributions__gt_homo_dist_tau(__Pyx_memviewslice, __Pyx_memviewslice, double, double, long, __Pyx_memviewslice); /*proto*/
static double __pyx_f_9admixfrog_5utils_13distributions__gt_homo_gtmode_single(char, char, double, double, double, double); /*proto*/
...
#define __Pyx_MODULE_NAME "admixfrog.utils.distributions"
extern int __pyx_module_is_main_admixfrog__utils__distributions;
int __pyx_module_is_main_admixfrog__utils__distributions = 0;

/* Implementation of 'admixfrog.utils.distributions' */
...
static const char __pyx_k_n_snps[] = "n_snps";
...
static const char __pyx_k_gt_homo_dist[] = "gt_homo_dist";
...
static const char __pyx_k_admixfrog_utils_distributions[] = "admixfrog.utils.distributions";
...
static const char __pyx_k_admixfrog_utils_distributions_py[] = "admixfrog/utils/distributions.pyx";
...
static PyObject *__pyx_n_s_admixfrog_utils_distributions;
static PyObject *__pyx_kp_s_admixfrog_utils_distributions_py;
...
static PyObject *__pyx_pf_9admixfrog_5utils_13distributions_gt_homo_gtmode(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_o, __Pyx_memviewslice __pyx_v_n, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res); /* proto */
static PyObject *__pyx_pf_9admixfrog_5utils_13distributions_2gt_homo_dist(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res); /* proto */
...
/* "admixfrog/utils/distributions.pyx":11
...
static double __pyx_f_9admixfrog_5utils_13distributions_dbinom_single(int __pyx_v_k, int __pyx_v_N, double __pyx_v_p) {
  double __pyx_r;

  /* "admixfrog/utils/distributions.pyx":12
 * 
 * cdef double dbinom_single(int k, int N, double p) nogil:
 *     return scs.binom(N, k) * pow(p,k) * pow(1.-p, N-k)             # <<<<<<<<<<<<<<
 * 
...
/* "admixfrog/utils/distributions.pyx":14
 *     return scs.binom(N, k) * pow(p,k) * pow(1.-p, N-k)
 * 
 * def gt_homo_gtmode(char[:] o, char[:] n,             # <<<<<<<<<<<<<<
 *                    double[:] a, double[:] b,
...
/* Python wrapper */
static PyObject *__pyx_pw_9admixfrog_5utils_13distributions_1gt_homo_gtmode(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_9admixfrog_5utils_13distributions_1gt_homo_gtmode = {"gt_homo_gtmode", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9admixfrog_5utils_13distributions_1gt_homo_gtmode, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9admixfrog_5utils_13distributions_1gt_homo_gtmode(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("admixfrog.utils.distributions.gt_homo_gtmode", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9admixfrog_5utils_13distributions_gt_homo_gtmode(__pyx_self, __pyx_v_o, __pyx_v_n, __pyx_v_a, __pyx_v_b, __pyx_v_F, __pyx_v_tau, __pyx_v_n_snps, __pyx_v_res);
...
static PyObject *__pyx_pf_9admixfrog_5utils_13distributions_gt_homo_gtmode(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_o, __Pyx_memviewslice __pyx_v_n, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res) {
  int __pyx_v_i;
  ...
  /* "admixfrog/utils/distributions.pyx":18
 *                    double F, double tau, long n_snps, double[:] res):
 *     cdef int i
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "admixfrog/utils/distributions.pyx":19
 *     cdef int i
 *     for i in range(n_snps):
 *         res[i] = _gt_homo_gtmode_single(o=o[i], n=n[i], a=a[i], b=b[i], F=F, tau=tau)             # <<<<<<<<<<<<<<
 * 
...
/* "admixfrog/utils/distributions.pyx":22
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_9admixfrog_5utils_13distributions_3gt_homo_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_9admixfrog_5utils_13distributions_3gt_homo_dist = {"gt_homo_dist", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9admixfrog_5utils_13distributions_3gt_homo_dist, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9admixfrog_5utils_13distributions_3gt_homo_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_b = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_F;
  double __pyx_v_tau;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("admixfrog.utils.distributions.gt_homo_dist", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9admixfrog_5utils_13distributions_2gt_homo_dist(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_F, __pyx_v_tau, __pyx_v_n_snps, __pyx_v_res);
...
static PyObject *__pyx_pf_9admixfrog_5utils_13distributions_2gt_homo_dist(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("gt_homo_dist", 0);

  /* "admixfrog/utils/distributions.pyx":23
 * 
 * def gt_homo_dist(double[:] a, double[:] b, double F, double tau, long n_snps, double[:, :] res):
 *     _gt_homo_dist_tau(a, b, F, tau, n_snps, res)             # <<<<<<<<<<<<<<
 * cdef void _gt_homo_dist(double[:] a, double[:] b, double F, long n_snps, double[:, :] res):
 *     cdef long i, g
 */
  __pyx_f_9admixfrog_5utils_13distributions__gt_homo_dist_tau(__pyx_v_a, __pyx_v_b, __pyx_v_F, __pyx_v_tau, __pyx_v_n_snps, __pyx_v_res);
...
/* "admixfrog/utils/distributions.pyx":24
 * def gt_homo_dist(double[:] a, double[:] b, double F, double tau, long n_snps, double[:, :] res):
 *     _gt_homo_dist_tau(a, b, F, tau, n_snps, res)
 * cdef void _gt_homo_dist(double[:] a, double[:] b, double F, long n_snps, double[:, :] res):             # <<<<<<<<<<<<<<
 *     cdef long i, g
...
static void __pyx_f_9admixfrog_5utils_13distributions__gt_homo_dist(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res) {
  long __pyx_v_i;
  __Pyx_RefNannyDeclarations
  long __pyx_t_1;
  long __pyx_t_2;
  ...
  /* "admixfrog/utils/distributions.pyx":26
 * cdef void _gt_homo_dist(double[:] a, double[:] b, double F, long n_snps, double[:, :] res):
 *     cdef long i, g
 *     for i in range(n_snps):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "admixfrog/utils/distributions.pyx":27
 *     cdef long i, g
 *     for i in range(n_snps):
 *         res[i, 0] =  (b[i]*b[i] + b[i] + a[i]*b[i]*F) / (a[i] + b[i]) / (a[i] + b[i] + 1)             # <<<<<<<<<<<<<<
 *         res[i, 2] =  (a[i]*a[i] + a[i] + a[i]*b[i]*F) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 ...
 */
    ...
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_13 * __pyx_v_res.strides[0]) ) + __pyx_t_14 * __pyx_v_res.strides[1]) )) = ((((((*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_4 * __pyx_v_b.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_5 * __pyx_v_b.strides[0]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_6 * __pyx_v_b.strides[0]) )))) + (((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_7 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_8 * __pyx_v_b.strides[0]) )))) * __pyx_v_F)) / ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_9 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_10 * __pyx_v_b.strides[0]) ))))) / (((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_11 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_12 * __pyx_v_b.strides[0]) )))) + 1.0));
    ...
    /* "admixfrog/utils/distributions.pyx":28
 *     for i in range(n_snps):
 *         res[i, 0] =  (b[i]*b[i] + b[i] + a[i]*b[i]*F) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 *         res[i, 2] =  (a[i]*a[i] + a[i] + a[i]*b[i]*F) / (a[i] + b[i]) / (a[i] + b[i] + 1)             # <<<<<<<<<<<<<<
 *         res[i, 1] =  (2.*a[i]*b[i]*(1-F)) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 ...
 */
    ...
    __pyx_t_13 = 2;
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_14 * __pyx_v_res.strides[0]) ) + __pyx_t_13 * __pyx_v_res.strides[1]) )) = ((((((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_12 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_11 * __pyx_v_a.strides[0]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_10 * __pyx_v_a.strides[0]) )))) + (((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_9 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_8 * __pyx_v_b.strides[0]) )))) * __pyx_v_F)) / ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_7 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_6 * __pyx_v_b.strides[0]) ))))) / (((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_5 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_4 * __pyx_v_b.strides[0]) )))) + 1.0));

    /* "admixfrog/utils/distributions.pyx":29
 *         res[i, 0] =  (b[i]*b[i] + b[i] + a[i]*b[i]*F) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 *         res[i, 2] =  (a[i]*a[i] + a[i] + a[i]*b[i]*F) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 *         res[i, 1] =  (2.*a[i]*b[i]*(1-F)) / (a[i] + b[i]) / (a[i] + b[i] + 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_10 = __pyx_v_i;
    __pyx_t_11 = 1;
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_10 * __pyx_v_res.strides[0]) ) + __pyx_t_11 * __pyx_v_res.strides[1]) )) = (((((2. * (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_4 * __pyx_v_a.strides[0]) )))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_5 * __pyx_v_b.strides[0]) )))) * (1.0 - __pyx_v_F)) / ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_6 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_7 * __pyx_v_b.strides[0]) ))))) / (((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_8 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_9 * __pyx_v_b.strides[0]) )))) + 1.0));
  }
...
/* "admixfrog/utils/distributions.pyx":31
 *         res[i, 1] =  (2.*a[i]*b[i]*(1-F)) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 * 
 * cdef void _gt_homo_dist_tau(double[:] a, double[:] b, double F, double tau, long n_snps, double[:, :] res):             # <<<<<<<<<<<<<<
 *     cdef long i, g
...
static void __pyx_f_9admixfrog_5utils_13distributions__gt_homo_dist_tau(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_F, double __pyx_v_tau, long __pyx_v_n_snps, __Pyx_memviewslice __pyx_v_res) {
  long __pyx_v_i;
  __Pyx_RefNannyDeclarations
  long __pyx_t_1;
  long __pyx_t_2;
  ...
  /* "admixfrog/utils/distributions.pyx":33
 * cdef void _gt_homo_dist_tau(double[:] a, double[:] b, double F, double tau, long n_snps, double[:, :] res):
 *     cdef long i, g
 *     for i in range(n_snps):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "admixfrog/utils/distributions.pyx":34
 *     cdef long i, g
 *     for i in range(n_snps):
 *         res[i, 0] =  (b[i]*b[i]*tau + b[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)             # <<<<<<<<<<<<<<
 *         res[i, 2] =  (a[i]*a[i]*tau + a[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)
 ...
 */
    ...
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_13 * __pyx_v_res.strides[0]) ) + __pyx_t_14 * __pyx_v_res.strides[1]) )) = (((((((*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_4 * __pyx_v_b.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_5 * __pyx_v_b.strides[0]) )))) * __pyx_v_tau) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_6 * __pyx_v_b.strides[0]) )))) + ((((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_7 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_8 * __pyx_v_b.strides[0]) )))) * __pyx_v_F) * __pyx_v_tau)) / ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_9 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_10 * __pyx_v_b.strides[0]) ))))) / (((__pyx_v_tau * (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_11 * __pyx_v_a.strides[0]) )))) + (__pyx_v_tau * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_12 * __pyx_v_b.strides[0]) ))))) + 1.0));
    ...
    /* "admixfrog/utils/distributions.pyx":35
 *     for i in range(n_snps):
 *         res[i, 0] =  (b[i]*b[i]*tau + b[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)
 *         res[i, 2] =  (a[i]*a[i]*tau + a[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)             # <<<<<<<<<<<<<<
 *         res[i, 1] =  1 - res[i, 0] - res[i, 2] #(2.*a[i]*b[i]*(1-F) * (1-tau)) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 ...
 */
    ...
    __pyx_t_14 = __pyx_v_i;
    __pyx_t_13 = 2;
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_14 * __pyx_v_res.strides[0]) ) + __pyx_t_13 * __pyx_v_res.strides[1]) )) = (((((((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_12 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_11 * __pyx_v_a.strides[0]) )))) * __pyx_v_tau) + (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_10 * __pyx_v_a.strides[0]) )))) + ((((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_9 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_8 * __pyx_v_b.strides[0]) )))) * __pyx_v_F) * __pyx_v_tau)) / ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_7 * __pyx_v_a.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_6 * __pyx_v_b.strides[0]) ))))) / (((__pyx_v_tau * (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_5 * __pyx_v_a.strides[0]) )))) + (__pyx_v_tau * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_4 * __pyx_v_b.strides[0]) ))))) + 1.0));

    /* "admixfrog/utils/distributions.pyx":36
 *         res[i, 0] =  (b[i]*b[i]*tau + b[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)
 *         res[i, 2] =  (a[i]*a[i]*tau + a[i] + a[i]*b[i]*F * tau) / (a[i] + b[i]) / (tau *a[i] + tau *b[i] + 1)
 *         res[i, 1] =  1 - res[i, 0] - res[i, 2] #(2.*a[i]*b[i]*(1-F) * (1-tau)) / (a[i] + b[i]) / (a[i] + b[i] + 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_8 = __pyx_v_i;
    __pyx_t_9 = 1;
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_8 * __pyx_v_res.strides[0]) ) + __pyx_t_9 * __pyx_v_res.strides[1]) )) = ((1.0 - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_4 * __pyx_v_res.strides[0]) ) + __pyx_t_5 * __pyx_v_res.strides[1]) )))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_res.data + __pyx_t_6 * __pyx_v_res.strides[0]) ) + __pyx_t_7 * __pyx_v_res.strides[1]) ))));
  }
...
/* "admixfrog/utils/distributions.pyx":38
 *         res[i, 1] =  1 - res[i, 0] - res[i, 2] #(2.*a[i]*b[i]*(1-F) * (1-tau)) / (a[i] + b[i]) / (a[i] + b[i] + 1)
 * 
 * cdef double _gt_homo_gtmode_single(char o, char n, double a, double b, double F, double tau):             # <<<<<<<<<<<<<<
 *     if n == 0:
...
static double __pyx_f_9admixfrog_5utils_13distributions__gt_homo_gtmode_single(char __pyx_v_o, char __pyx_v_n, double __pyx_v_a, double __pyx_v_b, double __pyx_v_F, double __pyx_v_tau) {
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("_gt_homo_gtmode_single", 0);

  /* "admixfrog/utils/distributions.pyx":39
 * 
 * cdef double _gt_homo_gtmode_single(char o, char n, double a, double b, double F, double tau):
 *     if n == 0:             # <<<<<<<<<<<<<<
 *         return 1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "admixfrog/utils/distributions.pyx":40
 * cdef double _gt_homo_gtmode_single(char o, char n, double a, double b, double F, double tau):
 *     if n == 0:
 *         return 1             # <<<<<<<<<<<<<<
 *     if n == 1:
 ...
 */
  ...
  /* "admixfrog/utils/distributions.pyx":41
 *     if n == 0:
 *         return 1
 *     if n == 1:             # <<<<<<<<<<<<<<
 *         return (a * o + b * (1-o)) / (a + b)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "admixfrog/utils/distributions.pyx":42
 *         return 1
 *     if n == 1:
 *         return (a * o + b * (1-o)) / (a + b)             # <<<<<<<<<<<<<<
 *     if n == 2:
 ...
 */
  ...
  /* "admixfrog/utils/distributions.pyx":43
 *     if n == 1:
 *         return (a * o + b * (1-o)) / (a + b)
 *     if n == 2:             # <<<<<<<<<<<<<<
 *         if o == 0:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "admixfrog/utils/distributions.pyx":44
 *         return (a * o + b * (1-o)) / (a + b)
 *     if n == 2:
 *         if o == 0:             # <<<<<<<<<<<<<<
 *             return  (b*b*tau + b + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 ...
 */
    switch (__pyx_v_o) {
      ...
      /* "admixfrog/utils/distributions.pyx":45
 *     if n == 2:
 *         if o == 0:
 *             return  (b*b*tau + b + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)             # <<<<<<<<<<<<<<
 *         elif o == 2:
 ...
 */
      ...
      /* "admixfrog/utils/distributions.pyx":47
 *             return  (b*b*tau + b + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 *         elif o == 2:
 *             return (a*a*tau + a + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)             # <<<<<<<<<<<<<<
 *         elif o == 1:
 ...
 */
      ...
      /* "admixfrog/utils/distributions.pyx":46
 *         if o == 0:
 *             return  (b*b*tau + b + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 *         elif o == 2:             # <<<<<<<<<<<<<<
 *             return (a*a*tau + a + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 ...
 */
      ...
      /* "admixfrog/utils/distributions.pyx":49
 *             return (a*a*tau + a + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 *         elif o == 1:
 *             return (a*b*(1-F) * tau) / (a + b) / (tau *a + tau *b + 1)             # <<<<<<<<<<<<<<
 *     return -1
 */
      ...
      /* "admixfrog/utils/distributions.pyx":48
 *         elif o == 2:
 *             return (a*a*tau + a + a*b*F * tau) / (a + b) / (tau *a + tau *b + 1)
 *         elif o == 1:             # <<<<<<<<<<<<<<
 *             return (a*b*(1-F) * tau) / (a + b) / (tau *a + tau *b + 1)
 ...
 */
  ...
  /* "admixfrog/utils/distributions.pyx":50
 *         elif o == 1:
 *             return (a*b*(1-F) * tau) / (a + b) / (tau *a + tau *b + 1)
 *     return -1             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "admixfrog.utils.distributions.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "admixfrog.utils.distributions.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "admixfrog.utils.distributions.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "admixfrog.utils.distributions._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_admixfrog_utils_distributions, __pyx_k_admixfrog_utils_distributions, sizeof(__pyx_k_admixfrog_utils_distributions), 0, 0, 1, 1},
  {&__pyx_kp_s_admixfrog_utils_distributions_py, __pyx_k_admixfrog_utils_distributions_py, sizeof(__pyx_k_admixfrog_utils_distributions_py), 0, 0, 1, 0},
 ...
 *                    double F, double tau, long n_snps, double[:] res):
 */
  __pyx_tuple__20 = PyTuple_Pack(9, __pyx_n_s_o, __pyx_n_s_n, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_F, __pyx_n_s_tau, __pyx_n_s_n_snps, __pyx_n_s_res, __pyx_n_s_i); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(8, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_admixfrog_utils_distributions_py, __pyx_n_s_gt_homo_gtmode, 14, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 * cdef void _gt_homo_dist(double[:] a, double[:] b, double F, long n_snps, double[:, :] res):
 */
  __pyx_tuple__22 = PyTuple_Pack(6, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_F, __pyx_n_s_tau, __pyx_n_s_n_snps, __pyx_n_s_res); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(6, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_admixfrog_utils_distributions_py, __pyx_n_s_gt_homo_dist, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 22, __pyx_L1_error)
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "binom", (void (**)(void))&__pyx_f_5scipy_7special_14cython_special_binom, "double (double, double, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_admixfrog__utils__distributions) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "admixfrog.utils.distributions")) {
      if (unlikely(PyDict_SetItemString(modules, "admixfrog.utils.distributions", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                    double F, double tau, long n_snps, double[:] res):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9admixfrog_5utils_13distributions_1gt_homo_gtmode, NULL, __pyx_n_s_admixfrog_utils_distributions); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * cdef void _gt_homo_dist(double[:] a, double[:] b, double F, long n_snps, double[:, :] res):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9admixfrog_5utils_13distributions_3gt_homo_dist, NULL, __pyx_n_s_admixfrog_utils_distributions); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_gt_homo_dist, __pyx_t_1) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "admixfrog/utils/distributions.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init admixfrog.utils.distributions", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init admixfrog.utils.distributions");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
