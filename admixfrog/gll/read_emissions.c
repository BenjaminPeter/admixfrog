...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "admixfrog.gll.read_emissions",
        "sources": [
            "admixfrog/gll/read_emissions.pyx"
        ]
    },
    "module_name": "admixfrog.gll.read_emissions"
}
END: Cython Metadata */
...
#define __PYX_HAVE__admixfrog__gll__read_emissions
#define __PYX_HAVE_API__admixfrog__gll__read_emissions
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
/*--- Type declarations ---*/
struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination;
...
/* "admixfrog/gll/read_emissions.pyx":48
 *     return ll
 * 
...
struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination {
  ...
  PyObject *__pyx_v_P;
  PyObject *__pyx_v_PG;
  PyObject *__pyx_v_cont;
  PyObject *__pyx_v_error;
  PyObject *__pyx_v_est_options;
...
/* Module declarations from 'admixfrog.gll.read_emissions' */
static PyTypeObject *__pyx_ptype_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination = 0;
...
static double __pyx_f_9admixfrog_3gll_14read_emissions_get_po_given_c(double, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "admixfrog.gll.read_emissions"
extern int __pyx_module_is_main_admixfrog__gll__read_emissions;
int __pyx_module_is_main_admixfrog__gll__read_emissions = 0;

/* Implementation of 'admixfrog.gll.read_emissions' */
...
static const char __pyx_k_log_2[] = "log__";
...
static const char __pyx_k_est_error[] = "est_error";
...
static const char __pyx_k_est_options[] = "est_options";
...
static const char __pyx_k_est_contamination[] = "est_contamination";
...
static const char __pyx_k_admixfrog_gll_read_emissions[] = "admixfrog.gll.read_emissions";
...
static const char __pyx_k_admixfrog_gll_read_emissions_pyx[] = "admixfrog/gll/read_emissions.pyx";
...
static PyObject *__pyx_kp_u_L_BFGS_B;
...
static PyObject *__pyx_n_s_admixfrog_gll_read_emissions;
static PyObject *__pyx_kp_s_admixfrog_gll_read_emissions_pyx;
...
static PyObject *__pyx_n_u_est_contamination;
static PyObject *__pyx_n_u_est_error;
static PyObject *__pyx_n_s_est_options;
...
static PyObject *__pyx_pf_9admixfrog_3gll_14read_emissions_20update_contamination_get_po_given_c_all(PyObject *__pyx_self, PyObject *__pyx_v_args); /* proto */
static PyObject *__pyx_pf_9admixfrog_3gll_14read_emissions_update_contamination(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_cont, PyObject *__pyx_v_error, PyObject *__pyx_v_P, PyObject *__pyx_v_PG, PyObject *__pyx_v_IX, PyObject *__pyx_v_est_options); /* proto */
...
static PyObject *__pyx_tp_new_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* "admixfrog/gll/read_emissions.pyx":20
...
static double __pyx_f_9admixfrog_3gll_14read_emissions_get_po_given_c(double __pyx_v_c, double __pyx_v_e, __Pyx_memviewslice __pyx_v_O, __Pyx_memviewslice __pyx_v_N, __Pyx_memviewslice __pyx_v_P_cont, __Pyx_memviewslice __pyx_v_PG, __Pyx_memviewslice __pyx_v_rg2obs, __Pyx_memviewslice __pyx_v_obs2snp) {
  int __pyx_v_i;
  int __pyx_v_s;
  int __pyx_v_g;
  long __pyx_v_n_obs;
  ...
  /* "admixfrog/gll/read_emissions.pyx":33
 ...
 */
  ...
  /* "admixfrog/gll/read_emissions.pyx":35
 *     cdef double p,  ll = 0.
 * 
 *     n_obs = len(rg2obs)             # <<<<<<<<<<<<<<
 *     n_states = PG.shape[1]
 ...
 */
  ...
  /* "admixfrog/gll/read_emissions.pyx":36
 * 
 *     n_obs = len(rg2obs)
 *     n_states = PG.shape[1]             # <<<<<<<<<<<<<<
 *     for i in range(n_obs):
 ...
 */
  ...
  /* "admixfrog/gll/read_emissions.pyx":37
 *     n_obs = len(rg2obs)
 *     n_states = PG.shape[1]
 *     for i in range(n_obs):             # <<<<<<<<<<<<<<
 *         obs = rg2obs[i]
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "admixfrog/gll/read_emissions.pyx":38
 *     n_states = PG.shape[1]
 *     for i in range(n_obs):
 *         obs = rg2obs[i]             # <<<<<<<<<<<<<<
 *         snp = obs2snp[obs]
 ...
 */
    ...
    /* "admixfrog/gll/read_emissions.pyx":39
 *     for i in range(n_obs):
 *         obs = rg2obs[i]
 *         snp = obs2snp[obs]             # <<<<<<<<<<<<<<
 *         for g in range(3):
 ...
 */
    ...
    __pyx_v_snp = (*((long *) ( /* dim=0 */ (__pyx_v_obs2snp.data + __pyx_t_5 * __pyx_v_obs2snp.strides[0]) )));

    /* "admixfrog/gll/read_emissions.pyx":40
 *         obs = rg2obs[i]
 *         snp = obs2snp[obs]
 *         for g in range(3):             # <<<<<<<<<<<<<<
 *             p = c * P_cont[obs] + (1.-c) * g / 2.
 ...
 */
    for (__pyx_t_6 = 0; __pyx_t_6 < 3; __pyx_t_6+=1) {
      ...
      /* "admixfrog/gll/read_emissions.pyx":41
 *         snp = obs2snp[obs]
 *         for g in range(3):
 *             p = c * P_cont[obs] + (1.-c) * g / 2.             # <<<<<<<<<<<<<<
 *             p = p * (1-e) + (1-p) * e
 ...
 */
      __pyx_t_5 = __pyx_v_obs;
      __pyx_v_p = ((__pyx_v_c * (*((double *) ( /* dim=0 */ (__pyx_v_P_cont.data + __pyx_t_5 * __pyx_v_P_cont.strides[0]) )))) + (((1. - __pyx_v_c) * __pyx_v_g) / 2.));

      /* "admixfrog/gll/read_emissions.pyx":42
 *         for g in range(3):
 *             p = c * P_cont[obs] + (1.-c) * g / 2.
 *             p = p * (1-e) + (1-p) * e             # <<<<<<<<<<<<<<
 *             p = O[obs] * log(p) + (N[obs] - O[obs]) * log(1-p)
 ...
 */
      ...
      /* "admixfrog/gll/read_emissions.pyx":43
 *             p = c * P_cont[obs] + (1.-c) * g / 2.
 *             p = p * (1-e) + (1-p) * e
 *             p = O[obs] * log(p) + (N[obs] - O[obs]) * log(1-p)             # <<<<<<<<<<<<<<
 *             for s in range(n_states):
 ...
 */
      __pyx_t_5 = __pyx_v_obs;
      __pyx_t_7 = __pyx_v_obs;
      __pyx_t_8 = __pyx_v_obs;
      __pyx_v_p = (((*((char *) ( /* dim=0 */ (__pyx_v_O.data + __pyx_t_5 * __pyx_v_O.strides[0]) ))) * log(__pyx_v_p)) + (((*((char *) ( /* dim=0 */ (__pyx_v_N.data + __pyx_t_7 * __pyx_v_N.strides[0]) ))) - (*((char *) ( /* dim=0 */ (__pyx_v_O.data + __pyx_t_8 * __pyx_v_O.strides[0]) )))) * log((1.0 - __pyx_v_p))));

      /* "admixfrog/gll/read_emissions.pyx":44
 *             p = p * (1-e) + (1-p) * e
 *             p = O[obs] * log(p) + (N[obs] - O[obs]) * log(1-p)
 *             for s in range(n_states):             # <<<<<<<<<<<<<<
 *                 ll += PG[snp, s, g] * p
 ...
 */
      ...
      for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
        ...
        /* "admixfrog/gll/read_emissions.pyx":45
 *             p = O[obs] * log(p) + (N[obs] - O[obs]) * log(1-p)
 *             for s in range(n_states):
 *                 ll += PG[snp, s, g] * p             # <<<<<<<<<<<<<<
 *     return ll
 * 
 */
        __pyx_t_8 = __pyx_v_snp;
        __pyx_t_7 = __pyx_v_s;
        __pyx_t_5 = __pyx_v_g;
        __pyx_v_ll = (__pyx_v_ll + ((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_PG.data + __pyx_t_8 * __pyx_v_PG.strides[0]) ) + __pyx_t_7 * __pyx_v_PG.strides[1]) ) + __pyx_t_5 * __pyx_v_PG.strides[2]) ))) * __pyx_v_p));
      }
    }
  }

  /* "admixfrog/gll/read_emissions.pyx":46
 *             for s in range(n_states):
 *                 ll += PG[snp, s, g] * p
 *     return ll             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_9admixfrog_3gll_14read_emissions_1update_contamination(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9admixfrog_3gll_14read_emissions_update_contamination[] = "\n    update emissions by maximizing contamination parameter\n\n    cont: dict of contamination rates (by library)\n    error: dict of contamination rates (by library)\n    P: data structure with reference data\n    PG: Pr(G, Z | O)\n\n    ";
static PyMethodDef __pyx_mdef_9admixfrog_3gll_14read_emissions_1update_contamination = {"update_contamination", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9admixfrog_3gll_14read_emissions_1update_contamination, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9admixfrog_3gll_14read_emissions_update_contamination};
static PyObject *__pyx_pw_9admixfrog_3gll_14read_emissions_1update_contamination(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_cont = 0;
  PyObject *__pyx_v_error = 0;
  PyObject *__pyx_v_P = 0;
  PyObject *__pyx_v_PG = 0;
  PyObject *__pyx_v_IX = 0;
  PyObject *__pyx_v_est_options = 0;
  int __pyx_lineno = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_cont,&__pyx_n_s_error,&__pyx_n_s_P,&__pyx_n_s_PG,&__pyx_n_s_IX,&__pyx_n_s_est_options,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_est_options)) != 0)) kw_args--;
        else {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("admixfrog.gll.read_emissions.update_contamination", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9admixfrog_3gll_14read_emissions_update_contamination(__pyx_self, __pyx_v_cont, __pyx_v_error, __pyx_v_P, __pyx_v_PG, __pyx_v_IX, __pyx_v_est_options);
...
/* "admixfrog/gll/read_emissions.pyx":66
...
/* Python wrapper */
static PyObject *__pyx_pw_9admixfrog_3gll_14read_emissions_20update_contamination_1get_po_given_c_all(PyObject *__pyx_self, PyObject *__pyx_v_args); /*proto*/
static PyMethodDef __pyx_mdef_9admixfrog_3gll_14read_emissions_20update_contamination_1get_po_given_c_all = {"get_po_given_c_all", (PyCFunction)__pyx_pw_9admixfrog_3gll_14read_emissions_20update_contamination_1get_po_given_c_all, METH_O, 0};
static PyObject *__pyx_pw_9admixfrog_3gll_14read_emissions_20update_contamination_1get_po_given_c_all(PyObject *__pyx_self, PyObject *__pyx_v_args) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_po_given_c_all (wrapper)", 0);
  __pyx_r = __pyx_pf_9admixfrog_3gll_14read_emissions_20update_contamination_get_po_given_c_all(__pyx_self, ((PyObject *)__pyx_v_args));
...
static PyObject *__pyx_pf_9admixfrog_3gll_14read_emissions_20update_contamination_get_po_given_c_all(PyObject *__pyx_self, PyObject *__pyx_v_args) {
  struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *__pyx_cur_scope;
  struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *__pyx_outer_scope;
  ...
  __pyx_outer_scope = (struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *) __Pyx_CyFunction_GetClosure(__pyx_self);
  __pyx_cur_scope = __pyx_outer_scope;
  __Pyx_INCREF(__pyx_v_args);

  /* "admixfrog/gll/read_emissions.pyx":67
 * 
 *         def get_po_given_c_all(args):
 *             args = list(args)             # <<<<<<<<<<<<<<
 *             C = args.pop(0) if est_options['est_contamination'] else cont[lib]
 ...
 */
  __pyx_t_1 = PySequence_List(__pyx_v_args); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF_SET(__pyx_v_args, __pyx_t_1);
  __pyx_t_1 = 0;

  /* "admixfrog/gll/read_emissions.pyx":68
 *         def get_po_given_c_all(args):
 *             args = list(args)
 *             C = args.pop(0) if est_options['est_contamination'] else cont[lib]             # <<<<<<<<<<<<<<
 *             E = args.pop(0) if est_options['est_error'] else error[lib]
 * 
 */
  if (unlikely(!__pyx_cur_scope->__pyx_v_est_options)) { __Pyx_RaiseClosureNameError("est_options"); __PYX_ERR(0, 68, __pyx_L1_error) }
  __pyx_t_2 = __Pyx_PyObject_Dict_GetItem(__pyx_cur_scope->__pyx_v_est_options, __pyx_n_u_est_contamination); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_3 < 0)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (__pyx_t_3) {
    __pyx_t_2 = __Pyx_PyObject_PopIndex(__pyx_v_args, __pyx_int_0, 0, 1, Py_ssize_t, PyInt_FromSsize_t); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __pyx_t_2;
    __pyx_t_2 = 0;
  } else {
    if (unlikely(!__pyx_cur_scope->__pyx_v_cont)) { __Pyx_RaiseClosureNameError("cont"); __PYX_ERR(0, 68, __pyx_L1_error) }
    if (unlikely(!__pyx_cur_scope->__pyx_v_lib)) { __Pyx_RaiseClosureNameError("lib"); __PYX_ERR(0, 68, __pyx_L1_error) }
    __pyx_t_2 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_cont, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __pyx_t_2;
    __pyx_t_2 = 0;
  }
  ...
  /* "admixfrog/gll/read_emissions.pyx":69
 *             args = list(args)
 *             C = args.pop(0) if est_options['est_contamination'] else cont[lib]
 *             E = args.pop(0) if est_options['est_error'] else error[lib]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  if (unlikely(!__pyx_cur_scope->__pyx_v_est_options)) { __Pyx_RaiseClosureNameError("est_options"); __PYX_ERR(0, 69, __pyx_L1_error) }
  __pyx_t_2 = __Pyx_PyObject_Dict_GetItem(__pyx_cur_scope->__pyx_v_est_options, __pyx_n_u_est_error); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_3 < 0)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (__pyx_t_3) {
    __pyx_t_2 = __Pyx_PyObject_PopIndex(__pyx_v_args, __pyx_int_0, 0, 1, Py_ssize_t, PyInt_FromSsize_t); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 69, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __pyx_t_2;
    __pyx_t_2 = 0;
  } else {
    if (unlikely(!__pyx_cur_scope->__pyx_v_error)) { __Pyx_RaiseClosureNameError("error"); __PYX_ERR(0, 69, __pyx_L1_error) }
    if (unlikely(!__pyx_cur_scope->__pyx_v_lib)) { __Pyx_RaiseClosureNameError("lib"); __PYX_ERR(0, 69, __pyx_L1_error) }
    __pyx_t_2 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_error, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 69, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __pyx_t_2;
    __pyx_t_2 = 0;
  }
  ...
  /* "admixfrog/gll/read_emissions.pyx":71
 *             E = args.pop(0) if est_options['est_error'] else error[lib]
 * 
 *             prob = get_po_given_c(c=C,             # <<<<<<<<<<<<<<
 *                                  e=E,
 *                                  O=P.O,
 */
  __pyx_t_4 = __pyx_PyFloat_AsDouble(__pyx_v_C); if (unlikely((__pyx_t_4 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L1_error)

  /* "admixfrog/gll/read_emissions.pyx":72
 * 
 *             prob = get_po_given_c(c=C,
 *                                  e=E,             # <<<<<<<<<<<<<<
 *                                  O=P.O,
 *                                  N=P.N,
 */
  __pyx_t_5 = __pyx_PyFloat_AsDouble(__pyx_v_E); if (unlikely((__pyx_t_5 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 72, __pyx_L1_error)

  /* "admixfrog/gll/read_emissions.pyx":73
 *             prob = get_po_given_c(c=C,
 *                                  e=E,
 *                                  O=P.O,             # <<<<<<<<<<<<<<
 *                                  N=P.N,
 *                                  P_cont=P.P_cont,
 */
  if (unlikely(!__pyx_cur_scope->__pyx_v_P)) { __Pyx_RaiseClosureNameError("P"); __PYX_ERR(0, 73, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_cur_scope->__pyx_v_P, __pyx_n_s_O); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_char(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "admixfrog/gll/read_emissions.pyx":74
 *                                  e=E,
 *                                  O=P.O,
 *                                  N=P.N,             # <<<<<<<<<<<<<<
 *                                  P_cont=P.P_cont,
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_cur_scope->__pyx_v_P, __pyx_n_s_N); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_char(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "admixfrog/gll/read_emissions.pyx":75
 *                                  O=P.O,
 *                                  N=P.N,
 *                                  P_cont=P.P_cont,             # <<<<<<<<<<<<<<
 *                                  PG=PG,
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_cur_scope->__pyx_v_P, __pyx_n_s_P_cont); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "admixfrog/gll/read_emissions.pyx":76
 *                                  N=P.N,
 *                                  P_cont=P.P_cont,
 *                                  PG=PG,             # <<<<<<<<<<<<<<
 *                                  rg2obs = IX.RG2OBS[lib],
 *                                  obs2snp = IX.OBS2SNP)
 */
  if (unlikely(!__pyx_cur_scope->__pyx_v_PG)) { __Pyx_RaiseClosureNameError("PG"); __PYX_ERR(0, 76, __pyx_L1_error) }
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_cur_scope->__pyx_v_PG, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 76, __pyx_L1_error)

  /* "admixfrog/gll/read_emissions.pyx":77
 *                                  P_cont=P.P_cont,
 *                                  PG=PG,
 *                                  rg2obs = IX.RG2OBS[lib],             # <<<<<<<<<<<<<<
 *                                  obs2snp = IX.OBS2SNP)
 *             return -prob
 */
  if (unlikely(!__pyx_cur_scope->__pyx_v_IX)) { __Pyx_RaiseClosureNameError("IX"); __PYX_ERR(0, 77, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_cur_scope->__pyx_v_IX, __pyx_n_s_RG2OBS); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (unlikely(!__pyx_cur_scope->__pyx_v_lib)) { __Pyx_RaiseClosureNameError("lib"); __PYX_ERR(0, 77, __pyx_L1_error) }
  __pyx_t_2 = __Pyx_PyObject_GetItem(__pyx_t_1, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "admixfrog/gll/read_emissions.pyx":78
 *                                  PG=PG,
 *                                  rg2obs = IX.RG2OBS[lib],
 *                                  obs2snp = IX.OBS2SNP)             # <<<<<<<<<<<<<<
 *             return -prob
 * 
 */
  if (unlikely(!__pyx_cur_scope->__pyx_v_IX)) { __Pyx_RaiseClosureNameError("IX"); __PYX_ERR(0, 78, __pyx_L1_error) }
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_cur_scope->__pyx_v_IX, __pyx_n_s_OBS2SNP); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *                                  O=P.O,
 */
  __pyx_v_prob = __pyx_f_9admixfrog_3gll_14read_emissions_get_po_given_c(__pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9, __pyx_t_10, __pyx_t_11);
  ...
  /* "admixfrog/gll/read_emissions.pyx":79
 *                                  rg2obs = IX.RG2OBS[lib],
 *                                  obs2snp = IX.OBS2SNP)
 *             return -prob             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = PyFloat_FromDouble((-__pyx_v_prob)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_10, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_t_11, 1);
  __Pyx_AddTraceback("admixfrog.gll.read_emissions.update_contamination.get_po_given_c_all", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_9admixfrog_3gll_14read_emissions_update_contamination(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_cont, PyObject *__pyx_v_error, PyObject *__pyx_v_P, PyObject *__pyx_v_PG, PyObject *__pyx_v_IX, PyObject *__pyx_v_est_options) {
  struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *__pyx_cur_scope;
  ...
  __pyx_cur_scope = (struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *)__pyx_tp_new_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination(__pyx_ptype_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination, __pyx_empty_tuple, NULL);
  if (unlikely(!__pyx_cur_scope)) {
    __pyx_cur_scope = ((struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *)Py_None);
    __Pyx_INCREF(Py_None);
    __PYX_ERR(0, 48, __pyx_L1_error)
  } else {
    __Pyx_GOTREF(__pyx_cur_scope);
  }
  __pyx_cur_scope->__pyx_v_cont = __pyx_v_cont;
  __Pyx_INCREF(__pyx_cur_scope->__pyx_v_cont);
  __Pyx_GIVEREF(__pyx_cur_scope->__pyx_v_cont);
  ...
  __pyx_cur_scope->__pyx_v_est_options = __pyx_v_est_options;
  __Pyx_INCREF(__pyx_cur_scope->__pyx_v_est_options);
  __Pyx_GIVEREF(__pyx_cur_scope->__pyx_v_est_options);

  /* "admixfrog/gll/read_emissions.pyx":59
 * 
 *     """
 *     delta = 0.             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "admixfrog/gll/read_emissions.pyx":61
 *     delta = 0.
 * 
 *     for i in range(len(IX.libs)):             # <<<<<<<<<<<<<<
 *         lib = IX.libs[i]
 *         f_ = IX.RG2OBS[lib]
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_cur_scope->__pyx_v_IX, __pyx_n_s_libs); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "admixfrog/gll/read_emissions.pyx":62
 * 
 *     for i in range(len(IX.libs)):
 *         lib = IX.libs[i]             # <<<<<<<<<<<<<<
 *         f_ = IX.RG2OBS[lib]
 *         assert all(lib == P.lib[f_])
 */
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_cur_scope->__pyx_v_IX, __pyx_n_s_libs); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = __Pyx_GetItemInt(__pyx_t_1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_XGOTREF(__pyx_cur_scope->__pyx_v_lib);
    __Pyx_XDECREF_SET(__pyx_cur_scope->__pyx_v_lib, __pyx_t_5);
    __Pyx_GIVEREF(__pyx_t_5);
    __pyx_t_5 = 0;

    /* "admixfrog/gll/read_emissions.pyx":63
 *     for i in range(len(IX.libs)):
 *         lib = IX.libs[i]
 *         f_ = IX.RG2OBS[lib]             # <<<<<<<<<<<<<<
 *         assert all(lib == P.lib[f_])
 * 
 */
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_cur_scope->__pyx_v_IX, __pyx_n_s_RG2OBS); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_t_5, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_XDECREF_SET(__pyx_v_f_, __pyx_t_1);
    __pyx_t_1 = 0;

    /* "admixfrog/gll/read_emissions.pyx":64
 *         lib = IX.libs[i]
 *         f_ = IX.RG2OBS[lib]
 *         assert all(lib == P.lib[f_])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (unlikely(!Py_OptimizeFlag)) {
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_cur_scope->__pyx_v_P, __pyx_n_s_lib); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 64, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyObject_GetItem(__pyx_t_1, __pyx_v_f_); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 64, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = PyObject_RichCompare(__pyx_cur_scope->__pyx_v_lib, __pyx_t_5, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 64, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_builtin_all, __pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 64, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *             C = args.pop(0) if est_options['est_contamination'] else cont[lib]
 */
    __pyx_t_5 = __Pyx_CyFunction_New(&__pyx_mdef_9admixfrog_3gll_14read_emissions_20update_contamination_1get_po_given_c_all, 0, __pyx_n_s_update_contamination_locals_get, ((PyObject*)__pyx_cur_scope), __pyx_n_s_admixfrog_gll_read_emissions, __pyx_d, ((PyObject *)__pyx_codeobj__2)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 66, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_XDECREF_SET(__pyx_v_get_po_given_c_all, __pyx_t_5);
    __pyx_t_5 = 0;

    /* "admixfrog/gll/read_emissions.pyx":81
 *             return -prob
 * 
 *         init, bounds = [], []             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_XDECREF_SET(__pyx_v_init, ((PyObject*)__pyx_t_5));
    __pyx_t_5 = 0;
    __Pyx_XDECREF_SET(__pyx_v_bounds, ((PyObject*)__pyx_t_1));
    __pyx_t_1 = 0;

    /* "admixfrog/gll/read_emissions.pyx":82
 * 
 *         init, bounds = [], []
 *         if est_options['est_contamination']:             # <<<<<<<<<<<<<<
 *             init.append(cont[lib])
 ...
 */
    __pyx_t_1 = __Pyx_PyObject_Dict_GetItem(__pyx_cur_scope->__pyx_v_est_options, __pyx_n_u_est_contamination); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 82, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_6 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 82, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (__pyx_t_6) {

      /* "admixfrog/gll/read_emissions.pyx":83
 *         init, bounds = [], []
 *         if est_options['est_contamination']:
 *             init.append(cont[lib])             # <<<<<<<<<<<<<<
 *             bounds.append((0, 1-1e-10))
 ...
 */
      __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_cont, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 83, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_init, __pyx_t_1); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 83, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

      /* "admixfrog/gll/read_emissions.pyx":84
 *         if est_options['est_contamination']:
 *             init.append(cont[lib])
 *             bounds.append((0, 1-1e-10))             # <<<<<<<<<<<<<<
 *         if est_options['est_error']:
 ...
 */
      __pyx_t_1 = PyFloat_FromDouble((1.0 - 1e-10)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 84, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      ...
      __pyx_t_1 = 0;
      __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_bounds, __pyx_t_5); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 84, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    ...
    /* "admixfrog/gll/read_emissions.pyx":85
 *             init.append(cont[lib])
 *             bounds.append((0, 1-1e-10))
 *         if est_options['est_error']:             # <<<<<<<<<<<<<<
 *             init.append(error[lib])
 ...
 */
    __pyx_t_5 = __Pyx_PyObject_Dict_GetItem(__pyx_cur_scope->__pyx_v_est_options, __pyx_n_u_est_error); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 85, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 85, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (__pyx_t_6) {

      /* "admixfrog/gll/read_emissions.pyx":86
 *             bounds.append((0, 1-1e-10))
 *         if est_options['est_error']:
 *             init.append(error[lib])             # <<<<<<<<<<<<<<
 *             bounds.append((0.00001, .1))
 * 
 */
      __pyx_t_5 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_error, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 86, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_init, __pyx_t_5); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 86, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

      /* "admixfrog/gll/read_emissions.pyx":87
 *         if est_options['est_error']:
 *             init.append(error[lib])
 *             bounds.append((0.00001, .1))             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_bounds, __pyx_tuple__3); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 87, __pyx_L1_error)
 ...
 */
    ...
    /* "admixfrog/gll/read_emissions.pyx":89
 *             bounds.append((0.00001, .1))
 * 
 *         prev = get_po_given_c_all(init)             # <<<<<<<<<<<<<<
 ...
 *         opt = OO.x.tolist()
 */
    __pyx_t_5 = __pyx_pf_9admixfrog_3gll_14read_emissions_20update_contamination_get_po_given_c_all(__pyx_v_get_po_given_c_all, __pyx_v_init); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 89, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_XDECREF_SET(__pyx_v_prev, __pyx_t_5);
    __pyx_t_5 = 0;

    /* "admixfrog/gll/read_emissions.pyx":90
 * 
 *         prev = get_po_given_c_all(init)
 *         OO =  minimize(get_po_given_c_all, init, bounds=bounds, method="L-BFGS-B")             # <<<<<<<<<<<<<<
 *         opt = OO.x.tolist()
 * 
 */
    __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_minimize); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    ...
    PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_v_get_po_given_c_all);
    ...
    if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_bounds, __pyx_v_bounds) < 0) __PYX_ERR(0, 90, __pyx_L1_error)
    if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_method, __pyx_kp_u_L_BFGS_B) < 0) __PYX_ERR(0, 90, __pyx_L1_error)
    __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_1, __pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_XDECREF_SET(__pyx_v_OO, __pyx_t_9);
    __pyx_t_9 = 0;

    /* "admixfrog/gll/read_emissions.pyx":91
 *         prev = get_po_given_c_all(init)
 *         OO =  minimize(get_po_given_c_all, init, bounds=bounds, method="L-BFGS-B")
 *         opt = OO.x.tolist()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_v_OO, __pyx_n_s_x); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 91, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_tolist); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 91, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = NULL;
    ...
    /* "admixfrog/gll/read_emissions.pyx":93
 *         opt = OO.x.tolist()
 * 
 *         old_c, old_e = cont[lib], error[lib]             # <<<<<<<<<<<<<<
 *         if est_options['est_contamination']:
 *             cont[lib] = opt.pop(0)
 */
    __pyx_t_9 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_cont, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 93, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_error, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 93, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_XDECREF_SET(__pyx_v_old_c, __pyx_t_9);
    __pyx_t_9 = 0;
    __Pyx_XDECREF_SET(__pyx_v_old_e, __pyx_t_1);
    __pyx_t_1 = 0;

    /* "admixfrog/gll/read_emissions.pyx":94
 * 
 *         old_c, old_e = cont[lib], error[lib]
 *         if est_options['est_contamination']:             # <<<<<<<<<<<<<<
 *             cont[lib] = opt.pop(0)
 * 
 */
    __pyx_t_1 = __Pyx_PyObject_Dict_GetItem(__pyx_cur_scope->__pyx_v_est_options, __pyx_n_u_est_contamination); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 94, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_6 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 94, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (__pyx_t_6) {

      /* "admixfrog/gll/read_emissions.pyx":95
 *         old_c, old_e = cont[lib], error[lib]
 *         if est_options['est_contamination']:
 *             cont[lib] = opt.pop(0)             # <<<<<<<<<<<<<<
 * 
 *         if est_options['est_error']:
 */
      __pyx_t_1 = __Pyx_PyObject_PopIndex(__pyx_v_opt, __pyx_int_0, 0, 1, Py_ssize_t, PyInt_FromSsize_t); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 95, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (unlikely(PyObject_SetItem(__pyx_cur_scope->__pyx_v_cont, __pyx_cur_scope->__pyx_v_lib, __pyx_t_1) < 0)) __PYX_ERR(0, 95, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
    ...
    /* "admixfrog/gll/read_emissions.pyx":97
 *             cont[lib] = opt.pop(0)
 * 
 *         if est_options['est_error']:             # <<<<<<<<<<<<<<
 *             error[lib] = opt.pop(0)
 * 
 */
    __pyx_t_1 = __Pyx_PyObject_Dict_GetItem(__pyx_cur_scope->__pyx_v_est_options, __pyx_n_u_est_error); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_6 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (__pyx_t_6) {

      /* "admixfrog/gll/read_emissions.pyx":98
 * 
 *         if est_options['est_error']:
 *             error[lib] = opt.pop(0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_1 = __Pyx_PyObject_PopIndex(__pyx_v_opt, __pyx_int_0, 0, 1, Py_ssize_t, PyInt_FromSsize_t); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 98, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (unlikely(PyObject_SetItem(__pyx_cur_scope->__pyx_v_error, __pyx_cur_scope->__pyx_v_lib, __pyx_t_1) < 0)) __PYX_ERR(0, 98, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
    ...
    /* "admixfrog/gll/read_emissions.pyx":100
 *             error[lib] = opt.pop(0)
 * 
 *         log__ = "[%s|%s] \tc: [%.4f->%.4f]\t:" % (lib, len(f_), old_c, cont[lib])             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_9 = __Pyx_PyObject_FormatSimpleAndDecref(PyObject_Unicode(__pyx_cur_scope->__pyx_v_lib), __pyx_empty_unicode); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    ...
    __pyx_t_12 = PyObject_Length(__pyx_v_f_); if (unlikely(__pyx_t_12 == ((Py_ssize_t)-1))) __PYX_ERR(0, 100, __pyx_L1_error)
    __pyx_t_9 = __Pyx_PyUnicode_From_Py_ssize_t(__pyx_t_12, 0, ' ', 'd'); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_10 += __Pyx_PyUnicode_GET_LENGTH(__pyx_t_9);
    __Pyx_GIVEREF(__pyx_t_9);
    ...
    __pyx_t_9 = __Pyx_PyObject_Format(__pyx_v_old_c, __pyx_kp_u_4f); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_11 = (__Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_9) > __pyx_t_11) ? __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_9) : __pyx_t_11;
    __pyx_t_10 += __Pyx_PyUnicode_GET_LENGTH(__pyx_t_9);
    __Pyx_GIVEREF(__pyx_t_9);
    ...
    __pyx_t_9 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_cont, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_8 = __Pyx_PyObject_Format(__pyx_t_9, __pyx_kp_u_4f); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    ...
    __pyx_t_8 = __Pyx_PyUnicode_Join(__pyx_t_1, 9, __pyx_t_10, __pyx_t_11); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_XDECREF_SET(__pyx_v_log__, ((PyObject*)__pyx_t_8));
    __pyx_t_8 = 0;

    /* "admixfrog/gll/read_emissions.pyx":101
 * 
 *         log__ = "[%s|%s] \tc: [%.4f->%.4f]\t:" % (lib, len(f_), old_c, cont[lib])
 *         log__ += "e: [%.4f->%.4f]:\t%.4f" % (old_e, error[lib], prev - OO.fun)             # <<<<<<<<<<<<<<
 *         log_.info(log__)
 ...
 */
    __pyx_t_8 = PyTuple_New(6); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_10 = 0;
    __pyx_t_11 = 127;
    ...
    PyTuple_SET_ITEM(__pyx_t_8, 0, __pyx_kp_u_e);
    __pyx_t_1 = __Pyx_PyObject_Format(__pyx_v_old_e, __pyx_kp_u_4f); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_error, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_9 = __Pyx_PyObject_Format(__pyx_t_1, __pyx_kp_u_4f); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_11 = (__Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_9) > __pyx_t_11) ? __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_9) : __pyx_t_11;
    __pyx_t_10 += __Pyx_PyUnicode_GET_LENGTH(__pyx_t_9);
    ...
    __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_v_OO, __pyx_n_s_fun); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_1 = PyNumber_Subtract(__pyx_v_prev, __pyx_t_9); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = __Pyx_PyObject_Format(__pyx_t_1, __pyx_kp_u_4f); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    ...
    __pyx_t_9 = 0;
    __pyx_t_9 = __Pyx_PyUnicode_Join(__pyx_t_8, 6, __pyx_t_10, __pyx_t_11); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyUnicode_Concat(__pyx_v_log__, __pyx_t_9); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF_SET(__pyx_v_log__, ((PyObject*)__pyx_t_8));
    __pyx_t_8 = 0;

    /* "admixfrog/gll/read_emissions.pyx":102
 *         log__ = "[%s|%s] \tc: [%.4f->%.4f]\t:" % (lib, len(f_), old_c, cont[lib])
 *         log__ += "e: [%.4f->%.4f]:\t%.4f" % (old_e, error[lib], prev - OO.fun)
 *         log_.info(log__)             # <<<<<<<<<<<<<<
 *         delta += abs(cont[lib] - old_c) + abs(error[lib] - old_e)
 * 
 */
    __Pyx_GetModuleGlobalName(__pyx_t_9, __pyx_n_s_log); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_info); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = NULL;
    ...
    __pyx_t_8 = (__pyx_t_9) ? __Pyx_PyObject_Call2Args(__pyx_t_1, __pyx_t_9, __pyx_v_log__) : __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_v_log__);
    ...
    /* "admixfrog/gll/read_emissions.pyx":103
 *         log__ += "e: [%.4f->%.4f]:\t%.4f" % (old_e, error[lib], prev - OO.fun)
 *         log_.info(log__)
 *         delta += abs(cont[lib] - old_c) + abs(error[lib] - old_e)             # <<<<<<<<<<<<<<
 * 
 *     return delta
 */
    __pyx_t_8 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_cont, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 103, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_1 = PyNumber_Subtract(__pyx_t_8, __pyx_v_old_c); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 103, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyNumber_Absolute(__pyx_t_1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 103, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_cur_scope->__pyx_v_error, __pyx_cur_scope->__pyx_v_lib); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 103, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_9 = PyNumber_Subtract(__pyx_t_1, __pyx_v_old_e); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 103, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyNumber_Absolute(__pyx_t_9); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 103, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = PyNumber_Add(__pyx_t_8, __pyx_t_1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 103, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = PyNumber_InPlaceAdd(__pyx_v_delta, __pyx_t_9); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 103, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  ...
  /* "admixfrog/gll/read_emissions.pyx":105
 *         delta += abs(cont[lib] - old_c) + abs(error[lib] - old_e)
 * 
 *     return delta             # <<<<<<<<<<<<<<
 */
 ...
 *             self.mode = u'c'
 */
  __pyx_t_4 = (__Pyx_PyString_Equals(__pyx_v_mode, __pyx_n_s_c_2, Py_EQ)); if (unlikely(__pyx_t_4 < 0)) __PYX_ERR(1, 161, __pyx_L1_error)
  if (likely(__pyx_t_4)) {
 ...
 */
  __pyx_t_1 = (__Pyx_PyUnicode_Equals(__pyx_v_self->mode, __pyx_n_u_c_2, Py_EQ)); if (unlikely(__pyx_t_1 < 0)) __PYX_ERR(1, 188, __pyx_L1_error)
...
static struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *__pyx_freelist_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination[8];
static int __pyx_freecount_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination = 0;

static PyObject *__pyx_tp_new_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  PyObject *o;
  if (CYTHON_COMPILING_IN_CPYTHON && likely((__pyx_freecount_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination > 0) & (t->tp_basicsize == sizeof(struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination)))) {
    o = (PyObject*)__pyx_freelist_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination[--__pyx_freecount_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination];
    memset(o, 0, sizeof(struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination));
...
static void __pyx_tp_dealloc_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination(PyObject *o) {
  struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *p = (struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *)o;
  PyObject_GC_UnTrack(o);
  Py_CLEAR(p->__pyx_v_IX);
  Py_CLEAR(p->__pyx_v_P);
  Py_CLEAR(p->__pyx_v_PG);
  Py_CLEAR(p->__pyx_v_cont);
  Py_CLEAR(p->__pyx_v_error);
  Py_CLEAR(p->__pyx_v_est_options);
  Py_CLEAR(p->__pyx_v_lib);
  if (CYTHON_COMPILING_IN_CPYTHON && ((__pyx_freecount_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination < 8) & (Py_TYPE(o)->tp_basicsize == sizeof(struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination)))) {
    __pyx_freelist_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination[__pyx_freecount_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination++] = ((struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *)o);
  } else {
    (*Py_TYPE(o)->tp_free)(o);
  }
}

static int __pyx_tp_traverse_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination(PyObject *o, visitproc v, void *a) {
  int e;
  struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *p = (struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *)o;
  if (p->__pyx_v_IX) {
  ...
  if (p->__pyx_v_cont) {
    e = (*v)(p->__pyx_v_cont, a); if (e) return e;
  }
  if (p->__pyx_v_error) {
    e = (*v)(p->__pyx_v_error, a); if (e) return e;
  }
  if (p->__pyx_v_est_options) {
    e = (*v)(p->__pyx_v_est_options, a); if (e) return e;
  }
  if (p->__pyx_v_lib) {
...
static int __pyx_tp_clear_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination(PyObject *o) {
  PyObject* tmp;
  struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *p = (struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination *)o;
  ...
  Py_XDECREF(tmp);
  tmp = ((PyObject*)p->__pyx_v_cont);
  p->__pyx_v_cont = Py_None; Py_INCREF(Py_None);
  Py_XDECREF(tmp);
  tmp = ((PyObject*)p->__pyx_v_error);
  p->__pyx_v_error = Py_None; Py_INCREF(Py_None);
  Py_XDECREF(tmp);
  tmp = ((PyObject*)p->__pyx_v_est_options);
  p->__pyx_v_est_options = Py_None; Py_INCREF(Py_None);
  Py_XDECREF(tmp);
...
static PyTypeObject __pyx_type_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination = {
  PyVarObject_HEAD_INIT(0, 0)
  "admixfrog.gll.read_emissions.__pyx_scope_struct__update_contamination", /*tp_name*/
  sizeof(struct __pyx_obj_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination, /*tp_dealloc*/
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination, /*tp_traverse*/
  __pyx_tp_clear_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_array = {
  PyVarObject_HEAD_INIT(0, 0)
  "admixfrog.gll.read_emissions.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "admixfrog.gll.read_emissions.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "admixfrog.gll.read_emissions.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "admixfrog.gll.read_emissions._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_admixfrog_gll_read_emissions, __pyx_k_admixfrog_gll_read_emissions, sizeof(__pyx_k_admixfrog_gll_read_emissions), 0, 0, 1, 1},
  {&__pyx_kp_s_admixfrog_gll_read_emissions_pyx, __pyx_k_admixfrog_gll_read_emissions_pyx, sizeof(__pyx_k_admixfrog_gll_read_emissions_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_u_est_contamination, __pyx_k_est_contamination, sizeof(__pyx_k_est_contamination), 0, 1, 0, 1},
  {&__pyx_n_u_est_error, __pyx_k_est_error, sizeof(__pyx_k_est_error), 0, 1, 0, 1},
  {&__pyx_n_s_est_options, __pyx_k_est_options, sizeof(__pyx_k_est_options), 0, 0, 1, 1},
 ...
 *             C = args.pop(0) if est_options['est_contamination'] else cont[lib]
 */
  __pyx_tuple_ = PyTuple_Pack(4, __pyx_n_s_args, __pyx_n_s_C, __pyx_n_s_E, __pyx_n_s_prob); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(1, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_admixfrog_gll_read_emissions_pyx, __pyx_n_s_get_po_given_c_all, 66, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 66, __pyx_L1_error)
 ...
 *         prev = get_po_given_c_all(init)
 */
  __pyx_tuple__3 = PyTuple_Pack(2, __pyx_float_0_00001, __pyx_float__1); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 87, __pyx_L1_error)
 ...
 *     """
 */
  __pyx_tuple__28 = PyTuple_Pack(20, __pyx_n_s_cont, __pyx_n_s_error, __pyx_n_s_P, __pyx_n_s_PG, __pyx_n_s_IX, __pyx_n_s_est_options, __pyx_n_s_delta, __pyx_n_s_i, __pyx_n_s_lib, __pyx_n_s_f, __pyx_n_s_get_po_given_c_all, __pyx_n_s_get_po_given_c_all, __pyx_n_s_init, __pyx_n_s_bounds, __pyx_n_s_prev, __pyx_n_s_OO, __pyx_n_s_opt, __pyx_n_s_old_c, __pyx_n_s_old_e, __pyx_n_s_log_2); if (unlikely(!__pyx_tuple__28)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__28);
  __Pyx_GIVEREF(__pyx_tuple__28);
  __pyx_codeobj__29 = (PyObject*)__Pyx_PyCode_New(6, 0, 20, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__28, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_admixfrog_gll_read_emissions_pyx, __pyx_n_s_update_contamination, 48, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__29)) __PYX_ERR(0, 48, __pyx_L1_error)
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination) < 0) __PYX_ERR(0, 48, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination.tp_print = 0;
  #endif
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination.tp_dictoffset && __pyx_type_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination.tp_getattro = __Pyx_PyObject_GenericGetAttrNoDict;
  }
  __pyx_ptype_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination = &__pyx_type_9admixfrog_3gll_14read_emissions___pyx_scope_struct__update_contamination;
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_admixfrog__gll__read_emissions) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "admixfrog.gll.read_emissions")) {
      if (unlikely(PyDict_SetItemString(modules, "admixfrog.gll.read_emissions", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "admixfrog/gll/read_emissions.pyx":5
 ...
 */
  ...
  /* "admixfrog/gll/read_emissions.pyx":6
 * 
 * import pandas as pd
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport scipy.special.cython_special as scs
 ...
 */
  ...
  /* "admixfrog/gll/read_emissions.pyx":11
 ...
 */
  ...
  /* "admixfrog/gll/read_emissions.pyx":12
 * from libc.stdio cimport printf
 * from scipy.optimize import minimize, minimize_scalar
 * from scipy.special import betaln             # <<<<<<<<<<<<<<
 * from scipy.stats import binom
 ...
 */
  ...
  /* "admixfrog/gll/read_emissions.pyx":13
 * from scipy.optimize import minimize, minimize_scalar
 * from scipy.special import betaln
 * from scipy.stats import binom             # <<<<<<<<<<<<<<
 * from ..utils.log import log_
 ...
 */
  ...
  /* "admixfrog/gll/read_emissions.pyx":14
 * from scipy.special import betaln
 * from scipy.stats import binom
 * from ..utils.log import log_             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_utils_log, __pyx_t_2, 2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     """
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9admixfrog_3gll_14read_emissions_1update_contamination, NULL, __pyx_n_s_admixfrog_gll_read_emissions); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_update_contamination, __pyx_t_1) < 0) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "admixfrog/gll/read_emissions.pyx":1
 * #!python             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init admixfrog.gll.read_emissions", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init admixfrog.gll.read_emissions");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
